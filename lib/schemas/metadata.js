...
module.exports = function(obj) {
  var name = obj.package.name,
    identifier = guid(obj);
  return {
    '@xmlns': 'http://ltsc.ieee.org/xsd/LOM',
    '@xmlns:xsi': 'http://www.w3.org/2001/XMLSchema-instance',
    '@xmlns:pkgprop' : "http://www.scorm.com/xsd/ScormEnginePackageProperties",
    '@xsi:schemaLocation' : "http://www.scorm.com/xsd/ScormEnginePackageProperties ScormEnginePackageProperties.xsd",
    metaMetadata: {
      ...
      duration: {
        ...
        description: {
          string: {
            '@language': obj.language,
            '#cdata':
              'The time it will take to watch the entire module from start to finish.',
          },
        },
      },
