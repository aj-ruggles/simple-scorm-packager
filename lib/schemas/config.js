...
module.exports = function(obj) {
  ...
  return {
    ...
    package: {
      ...
      timestamp: timestamp,
      size: obj.package.size || '1000000',
      version:
        obj.package.version || process.env.npm_package_version || '1.0.0',
      outputFolder: obj.package.outputFolder || './scorm',
      duration: obj.package.duration || 'PT0H0M0S',
      typicalDuration:
        obj.package.typicalDuration || obj.package.duration || 'PT0H0M0S',
      educational:
      ...
      zip: obj.package.zip,
      appendTimeToOutput:
        typeof obj.package.appendTimeToOutput === 'boolean'
          ? obj.package.appendTimeToOutput
          : false,
    },
